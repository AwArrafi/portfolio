...
export default function ProfessionalJourneySection() {
  return (
    <section
      ...
      className="relative overflow-hidden border-t border-slate-200 bg-[#f6f9ff] px-6 py-16 text-slate-900 md:px-10 lg:px-16"
    >
      <div className="absolute left-10 top-20 h-72 w-72 rounded-full bg-cyan-300/20 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.7fr_1fr]">
        <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] md:p-8">
          <div>
          ...
          <ol className="relative mt-8 space-y-8">
            <div
              className="absolute left-[11px] top-2 h-[calc(100%-1rem)] w-0.5 bg-slate-200"
              aria-hidden="true"
            />
